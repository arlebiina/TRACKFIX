...
<div class="content">
    <section class="sobre-section">
        <h1 class="sobre-titulo">Sobre o Trackfix</h1>

        <div class="sobre-grid">
            <div class="sobre-card">
                <span class="sobre-icon">🚀</span>
                <h3>Missão</h3>
                <p>Nossa missão é erradicar a perda de ativos, proporcionando um controle inteligente e em tempo real que transforma o caos em produtividade máxima.</p>
            </div>
